...
<<<<<<< HEAD
    ...
    public void F3PositiveTest() {
        ...
        String text = driver.findElement(By.cssSelector("body > div > div.content > table > tbody > tr > td:nth-child(2)")).getText();
    ...
    public void F4PositiveTest() { // added a book to book order
        ...
        driver.findElement(By.id("order-hall001")).click();
        driver.findElement(By.id("cartLink")).click();
        String id = driver.findElement(By.cssSelector("body > div > div.content > table > tbody > tr > td:nth-child(1)")).getText();
        assertEquals("hall001", id);
        String description = driver.findElement(By.cssSelector("body > div > div.content > table > tbody > tr > td:nth-child(2)")).getText();
        assertEquals("Core Servlets and JavaServer Pages 2nd Edition (Volume 1)", description);
        String cost = driver.findElement(By.cssSelector("body > div > div.content > table > tbody > tr > td:nth-child(3)")).getText();
    ...
    public void F4NegativeTest() {
        ...
        assertThrows(org.openqa.selenium.NoSuchElementException.class, () -> {
            driver.findElement(By.cssSelector("body > div > div.content > table > tbody > tr > td:nth-child(1)")).getText();
        }); // getting a description in an empty book order
        assertThrows(org.openqa.selenium.NoSuchElementException.class, () -> {
            driver.findElement(By.cssSelector("body > div > div.content > table > tbody > tr > td:nth-child(2)")).getText();
        }); // getting a cost
        assertThrows(org.openqa.selenium.NoSuchElementException.class, () -> {
            driver.findElement(By.cssSelector("body > div > div.content > table > tbody > tr > td:nth-child(3)")).getText();
        });
    }
    ...
    public void F6PositiveTest() { // added a book to book order
        ...
        assertEquals(formatter.format(new Date()), orderDate); // checking if the shipping cost is correct
    ...
    public void UseCaseTest1_1() {
        ...
        driver.findElement(By.id("loginBtn")).click();
        driver.get("http://localhost:8080/admin");
        String so = driver.findElement(By.cssSelector("body > div > div.menu > form:nth-child(3) > input[type=submit]")).getAttribute("value");
    ...
    public void UseCaseTest6_1() {
        ...
        driver.findElement(By.id("cartLink")).click();
        driver.get("http://localhost:8080/orderPage");
        String bookFound = driver.findElement(By.cssSelector("body > div > div.content > table > tbody > tr:nth-child(1) > td:nth-child(2)")).getText();
    ...
    public void UseCaseTest6_2() {
        ...
        driver.findElement(By.id("cartLink")).click();
        driver.get("http://localhost:8080/orderPage");
        String bookFound = driver.findElement(By.cssSelector("body > div > div.content > table > tbody > tr > td:nth-child(2)")).getText();
    ...
    public void UseCaseTest8_1() {
        ...
        number.clear();
        number.sendKeys("4");
        driver.findElement(By.cssSelector("body > div > div.content > table > tbody > tr > td:nth-child(4) > button")).click();
        driver.get("http://localhost:8080/orderPage");
    ...
    public void UseCaseTest9_1() {
        ...
        String received = driver.findElement(By.cssSelector("#checkoutTable > tbody > tr > td:nth-child(2) > p:nth-child(1) > span:nth-child(1)")).getText();
...
>>>>>>> eb003d869d2bd3a066d1cf39b1651a4a4b094248
}
